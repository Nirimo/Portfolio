  ...
  return (
    <div className="flex flex-row items-center justify-center w-full">
        <div className="flex items-center justify-center w-4/5 bg-[#272727] mt-10 h-[70px] border border-blue-700 rounded-[16px]">
            <div className="flex flex-row justify-between items-center w-[97%] max-lg:justify-center">
                <div className="">
                ...
                <div className="flex flex-row items-center justify-center text-[#a8a8a8] gap-20 text-lg max-lg:hidden">
                ...
                <a href="" className="flex flex-row items-center justify-center text-white bg-blue-700 px-4 py-2 rounded-[10px] text-lg max-lg:hidden">Me Contacter</a>
            </div>
        </div>
    </div>
  );
